        ...
        <div className="min-h-screen bg-gray-900 text-white">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className={`px-4 py-2 rounded-lg ${connected ? 'bg-green-600' : 'bg-red-600'}`}>
                ...
                {/* Chat Monitor & Admin Chat */}
                <div className="mt-8 bg-gray-800 rounded-lg p-6">
                    <h2 className="text-xl font-semibold mb-4">Chat Monitor & Admin Messages</h2>
                        ...
                        {chatMessages.length === 0 ? (
                            ...
                            chatMessages.map((message, index) => (
                                <div key={index} className="text-sm mb-2">
                                    <span className="text-blue-400 font-medium">[{message.roomName}]</span>
