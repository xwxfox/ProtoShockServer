FROM node:22-slim
ARG SOCKET_ENV_FILE_CONTENT=${SOCKET_ENV_FILE_CONTENT}
ARG WEB_ENV_FILE_CONTENT=${WEB_ENV_FILE_CONTENT}
ARG DATABASE_ENV_FILE_CONTENT=${DATABASE_ENV_FILE_CONTENT}
